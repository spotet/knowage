...
RUN mkdir ${JWS_HOME}/resources ${JWS_HOME}/conf/context.xml.d ${JWS_HOME}/conf/server.xml.d && mkdir ${JWS_HOME}/webapps/knowage && \
    ...
    wget -q --no-check-certificate "${KNOWAGE_BIRTREPORT_URL}" && unzip -o ${KNOWAGE_BIRTREPORT_ENGINE}-${KNOWAGE_PACKAGE_SUFFIX}.zip && rm ${KNOWAGE_BIRTREPORT_ENGINE}-${KNOWAGE_PACKAGE_SUFFIX}.zip && unzip ${KNOWAGE_BIRTREPORT_ENGINE}.war -d ${KNOWAGE_CORE_ENGINE} && rm ${KNOWAGE_BIRTREPORT_ENGINE}.war && \
    wget -q --no-check-certificate "${KNOWAGE_COCKPIT_URL}" && unzip -o ${KNOWAGE_COCKPIT_ENGINE}-${KNOWAGE_PACKAGE_SUFFIX}.zip && rm ${KNOWAGE_COCKPIT_ENGINE}-${KNOWAGE_PACKAGE_SUFFIX}.zip && unzip ${KNOWAGE_COCKPIT_ENGINE}.war -d ${KNOWAGE_CORE_ENGINE} && rm ${KNOWAGE_COCKPIT_ENGINE}.war && \
    wget -q --no-check-certificate "${KNOWAGE_COMMONJ_URL}" && unzip -o ${KNOWAGE_COMMONJ_ENGINE}-${KNOWAGE_PACKAGE_SUFFIX}.zip && rm ${KNOWAGE_COMMONJ_ENGINE}-${KNOWAGE_PACKAGE_SUFFIX}.zip && unzip ${KNOWAGE_COMMONJ_ENGINE}.war -d ${KNOWAGE_CORE_ENGINE} && rm ${KNOWAGE_COMMONJ_ENGINE}.war && \
    wget -q --no-check-certificate "${KNOWAGE_VUE_URL}" && unzip -o ${KNOWAGE_VUE_ENGINE}-${KNOWAGE_PACKAGE_SUFFIX}.zip && rm ${KNOWAGE_VUE_ENGINE}-${KNOWAGE_PACKAGE_SUFFIX}.zip && unzip ${KNOWAGE_VUE_ENGINE}.war -d ${KNOWAGE_CORE_ENGINE} && rm ${KNOWAGE_VUE_ENGINE}.war && \
    wget -q --no-check-certificate "${KNOWAGE_GEOREPORT_URL}" && unzip -o ${KNOWAGE_GEOREPORT_ENGINE}-${KNOWAGE_PACKAGE_SUFFIX}.zip && rm ${KNOWAGE_GEOREPORT_ENGINE}-${KNOWAGE_PACKAGE_SUFFIX}.zip && unzip ${KNOWAGE_GEOREPORT_ENGINE}.war -d ${KNOWAGE_CORE_ENGINE} && rm ${KNOWAGE_GEOREPORT_ENGINE}.war && \
    wget -q --no-check-certificate "${KNOWAGE_JASPERREPORT_URL}" && unzip -o ${KNOWAGE_JASPERREPORT_ENGINE}-${KNOWAGE_PACKAGE_SUFFIX}.zip && rm ${KNOWAGE_JASPERREPORT_ENGINE}-${KNOWAGE_PACKAGE_SUFFIX}.zip && unzip ${KNOWAGE_JASPERREPORT_ENGINE}.war -d ${KNOWAGE_CORE_ENGINE} && rm ${KNOWAGE_JASPERREPORT_ENGINE}.war && \
    wget -q --no-check-certificate "${KNOWAGE_KPI_URL}" && unzip -o ${KNOWAGE_KPI_ENGINE}-${KNOWAGE_PACKAGE_SUFFIX}.zip && rm ${KNOWAGE_KPI_ENGINE}-${KNOWAGE_PACKAGE_SUFFIX}.zip && unzip ${KNOWAGE_KPI_ENGINE}.war -d ${KNOWAGE_CORE_ENGINE} && rm ${KNOWAGE_KPI_ENGINE}.war && \
    wget -q --no-check-certificate "${KNOWAGE_META_URL}" && unzip -o ${KNOWAGE_META_ENGINE}-${KNOWAGE_PACKAGE_SUFFIX}.zip && rm ${KNOWAGE_META_ENGINE}-${KNOWAGE_PACKAGE_SUFFIX}.zip && unzip ${KNOWAGE_META_ENGINE}.war -d ${KNOWAGE_CORE_ENGINE} && rm ${KNOWAGE_META_ENGINE}.war && \
    wget -q --no-check-certificate "${KNOWAGE_API_URL}" && unzip -o ${KNOWAGE_API_ENGINE}-${KNOWAGE_PACKAGE_SUFFIX}.zip && rm ${KNOWAGE_API_ENGINE}-${KNOWAGE_PACKAGE_SUFFIX}.zip && unzip ${KNOWAGE_API_ENGINE}.war -d ${KNOWAGE_CORE_ENGINE} && rm ${KNOWAGE_API_ENGINE}.war && \
    wget -q --no-check-certificate "${KNOWAGE_QBE_URL}" && unzip -o ${KNOWAGE_QBE_ENGINE}-${KNOWAGE_PACKAGE_SUFFIX}.zip && rm ${KNOWAGE_QBE_ENGINE}-${KNOWAGE_PACKAGE_SUFFIX}.zip && unzip ${KNOWAGE_QBE_ENGINE}.war -d ${KNOWAGE_CORE_ENGINE} && rm ${KNOWAGE_QBE_ENGINE}.war && \
    wget -q --no-check-certificate "${KNOWAGE_SVGVIEWER_URL}" && unzip -o ${KNOWAGE_SVGVIEWER_ENGINE}-${KNOWAGE_PACKAGE_SUFFIX}.zip && rm ${KNOWAGE_SVGVIEWER_ENGINE}-${KNOWAGE_PACKAGE_SUFFIX}.zip && unzip ${KNOWAGE_SVGVIEWER_ENGINE}.war -d ${KNOWAGE_CORE_ENGINE} && rm ${KNOWAGE_SVGVIEWER_ENGINE}.war && \
    wget -q --no-check-certificate "${KNOWAGE_TALEND_URL}" && unzip -o ${KNOWAGE_TALEND_ENGINE}-${KNOWAGE_PACKAGE_SUFFIX}.zip && rm ${KNOWAGE_TALEND_ENGINE}-${KNOWAGE_PACKAGE_SUFFIX}.zip && unzip ${KNOWAGE_TALEND_ENGINE}.war -d ${KNOWAGE_CORE_ENGINE} && rm ${KNOWAGE_TALEND_ENGINE}.war && \
    wget -q --no-check-certificate "${KNOWAGE_WHATIF_URL}" && unzip -o ${KNOWAGE_WHATIF_ENGINE}-${KNOWAGE_PACKAGE_SUFFIX}.zip && rm ${KNOWAGE_WHATIF_ENGINE}-${KNOWAGE_PACKAGE_SUFFIX}.zip && unzip ${KNOWAGE_WHATIF_ENGINE}.war -d ${KNOWAGE_CORE_ENGINE} && rm ${KNOWAGE_WHATIF_ENGINE}.war
