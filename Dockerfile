...
RUN mkdir ${JWS_HOME}/resources ${JWS_HOME}/conf/context.xml.d ${JWS_HOME}/conf/server.xml.d && mkdir ${JWS_HOME}/webapps/knowage && \
    ...
    wget --no-check-certificate "${KNOWAGE_VUE_URL}" && unzip -o ${KNOWAGE_VUE_ENGINE}-${KNOWAGE_PACKAGE_SUFFIX}.zip && rm ${KNOWAGE_VUE_ENGINE}-${KNOWAGE_PACKAGE_SUFFIX}.zip && unzip ${KNOWAGE_VUE_ENGINE}.war -d ${KNOWAGE_VUE_ENGINE} && rm ${KNOWAGE_VUE_ENGINE}.war && \
    ...
    wget --no-check-certificate "${KNOWAGE_API_URL}" && unzip -o ${KNOWAGE_API_ENGINE}-${KNOWAGE_PACKAGE_SUFFIX}.zip && rm ${KNOWAGE_API_ENGINE}-${KNOWAGE_PACKAGE_SUFFIX}.zip && unzip ${KNOWAGE_API_ENGINE}.war -d ${KNOWAGE_API_ENGINE} && rm ${KNOWAGE_API_ENGINE}.war && \
